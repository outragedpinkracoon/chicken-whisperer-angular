        ...
        execute: function() {
            RaceGameInitializer = (function () {
                ...
                RaceGameInitializer.generateGame = function () {
                    ...
                    var chicken1 = new chicken_1.Chicken({ "id": 1, "name": "Popo", "speed": 14, "maxScare": 1 });
                    var chicken2 = new chicken_1.Chicken({ "id": 2, "name": "Pudgy", "speed": 5, "maxScare": 3 });
                    var chicken3 = new chicken_1.Chicken({ "id": 3, "name": "Jojo", "speed": 8, "maxScare": 3 });
                    var chicken4 = new chicken_1.Chicken({ "id": 4, "name": "Colin", "speed": 10, "maxScare": 2 });
